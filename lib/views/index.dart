...
class _HomeScreenState extends State<HomeScreen> {
  ...
  late String _hour, _minute, _time, _showHour;
  ...
  int calcMinute(TimeOfDay start, TimeOfDay end) {
  ...
  Future<void> _selectTimeOut(BuildContext context) async {
    ...
    if (picked != null) {
      setState(() {
        ...
        int calcHour = calcMinute(selectedTimeIn, selectedTimeOut);
        final int hour = calcHour ~/ 60;
        final int minutes = calcHour % 60; 
  ...
  Future<void> _selectTimeOut2(BuildContext context) async {
    ...
    if (picked != null) {
      setState(() {
        ...
        int calcHour = calcMinute(selectedTimeIn, selectedTimeOut) + calcMinute(selectedTimeIn2, selectedTimeOut2);
        final int hour = calcHour ~/ 60;
        final int minutes = calcHour % 60; 
        _showHour = hour.toString().padLeft(2, '0') + ' : ' + minutes.toString().padLeft(2, '0');
      });
  ...
  Future<void> _selectTimeOut3(BuildContext context) async {
    ...
    if (picked != null) {
      setState(() {
        ...
        int calcHour = calcMinute(selectedTimeIn, selectedTimeOut) + calcMinute(selectedTimeIn2, selectedTimeOut2) + calcMinute(selectedTimeIn3, selectedTimeOut3);
        final int hour = calcHour ~/ 60;
        final int minutes = calcHour % 60; 
        _showHour = hour.toString().padLeft(2, '0') + ' : ' + minutes.toString().padLeft(2, '0');
      });
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              child: Text(
                _showHour, // shows the calculation of total hours
